...
class InscriptionDraft(models.Model):
    ...
    modified_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, blank=True, related_name='inscription_drafts_modified', db_constraint=False)
