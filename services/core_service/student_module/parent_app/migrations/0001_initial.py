    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_email', models.EmailField(blank=True, max_length=100, null=True)),
                ...
                ('profession', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='parent_app.profession')),
            ],
            options={
                'db_table': 'parents',
            },
