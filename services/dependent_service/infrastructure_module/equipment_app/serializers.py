    ...
    def create(self, validated_data):
        ...
        try:
            ...
            raise serializers.ValidationError(
                {"equipment_type": "Invalid EquipmentType ID"}
            )
...
class EquipmentAllocationSerializer(serializers.ModelSerializer):
    ...
    allocated_to = serializers.UUIDField(
    ...
    def create(self, validated_data):
        ...
        return EquipmentAllocation.objects.create(
            equipment=equipment, room=room, allocated_to=user, **validated_data
        )
...
class EquipmentMaintenanceSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        return EquipmentMaintenance.objects.create(
