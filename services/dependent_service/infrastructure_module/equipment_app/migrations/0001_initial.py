    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('working', 'Working'), ('available', 'Available'), ('under_maintenance', 'Under Maintenance'), ('out_of_order', 'Out of Order'), ('disposed', 'Disposed')], default='available', max_length=86)),
            ],
            options={
                'db_table': 'equipments',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('active', 'Active'), ('returned', 'Returned'), ('lost', 'Lost')], default='active', max_length=120)),
            ],
            options={
