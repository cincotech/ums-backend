"""
Management command to export the database schema as SQL.
Generates CREATE TABLE, constraints, and indexes — structure only, no data, no comments.
"""
...
class Command(BaseCommand):
    help = "Export database schema as raw SQL (structure only, no comments)"
